...
const stylesCardSections = {
  ...
  h5Card:
    "p-2 text-md md:text-2xl font-bold tracking-tight text-center text-gray-900 capitalize",
  pCard:
    "p-2 text-sm md:text-md font-normal text-center text-gray-700 capitalize",
};
